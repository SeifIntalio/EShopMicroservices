...
public class InitialData
{
    ...
    {
        Customer.Create(CustomerId.Of(new Guid("76fe02d9-0868-4a32-9e1e-acb8492d1644")),"Seif","SeifSeoud10@gmail.com"),
        Customer.Create(CustomerId.Of(new Guid("02cc365c-1374-4c95-8e7c-a61f26ba5f0f")),"Mohamed","MohamedQotb20@gmail.com")
    };
